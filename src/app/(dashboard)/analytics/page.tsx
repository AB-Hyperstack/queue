...
export default function AnalyticsPage() {
  ...
  return (
    <div className="flex flex-col h-full">
      <TopBar title="Analytics" subtitle={`${org?.name} — Last 7 days`} />
      ...
      <div className="flex-1 overflow-auto p-6">
        ...
        <div className="grid grid-cols-2 gap-6">
          {/* Peak Times */}
          <Card>
            <h3 className="text-sm font-semibold text-gray-900 mb-4">Peak Times (Today)</h3>
            <div className="h-64">
          ...
          <Card>
            <h3 className="text-sm font-semibold text-gray-900 mb-4">Avg Wait Time (min)</h3>
            <div className="h-64">
              <ResponsiveContainer width="100%" height="100%">
          ...
          <Card className="col-span-2">
            <h3 className="text-sm font-semibold text-gray-900 mb-4">Daily Throughput</h3>
            <div className="h-64">
              <ResponsiveContainer width="100%" height="100%">
