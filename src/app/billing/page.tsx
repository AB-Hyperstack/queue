...
import { PLANS, PLAN_FEATURES } from '@/lib/billing/constants';
  ...
  return (
    <div className="w-full max-w-3xl">
      ...
      {isExpired && !checkoutSuccess && (
        <div className="mb-6 rounded-xl bg-red-50 border border-red-200 p-4 text-center">
          ...
          <p className="text-sm text-red-600 mt-1">
            Subscribe to continue using QueueFlow
          </p>
        </div>
      )}
      ...
      {isActive && !checkoutSuccess && (
        <div className="mb-6 rounded-xl bg-green-50 border border-green-100 p-4 text-center">
          <p className="text-sm font-medium text-green-800">
            Pro Plan &mdash; {subscription?.plan === 'yearly' ? 'Yearly' : 'Monthly'}
          </p>
      ...
      <div className="text-center mb-8">
        <h1 className="text-2xl font-bold text-gray-900">
          {isExpired ? 'Choose your plan' : isActive ? 'Manage your plan' : 'Upgrade your plan'}
        </h1>
        <p className="mt-2 text-gray-500">
          Simple pricing. Full access to all features.
        </p>
      </div>
      ...
      {!isActive ? (
        <Button className="w-full" onClick={handleSubscribe} loading={subscribing}>
          Subscribe &mdash; {selectedPlan === 'yearly' ? PLANS.yearly.priceDisplay + '/year' : PLANS.monthly.priceDisplay + '/month'}
        </Button>
      ) : (
